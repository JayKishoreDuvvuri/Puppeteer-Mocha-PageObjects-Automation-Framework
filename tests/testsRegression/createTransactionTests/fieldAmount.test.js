...
describe("Create Transaction Page : Negative Test to verify amount Field Error Message", function () {
  let page;
  ...
  it("Enter amount field as blank and check error message", async () => {
    await createTransactionPage.typeAmountBlank();
